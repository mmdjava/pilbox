...
try {
		Debug.PushSubsStack("Activity_Create (pill_4) ","pill_4",4,pill_4.mostCurrent.activityBA,pill_4.mostCurrent,50);
if (RapidSub.canDelegate("activity_create")) { return pill.boxV1.pill_4.remoteMe.runUserSub(false, "pill_4","activity_create", _firsttime);}
...
pill_4.mostCurrent._autocompleteedittext1.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(pill_4.mostCurrent.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(pill_4.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("interval_4.txt")))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",pill_4.processBA, e8.toString()); };
...
try {
		Debug.PushSubsStack("Activity_Pause (pill_4) ","pill_4",4,pill_4.mostCurrent.activityBA,pill_4.mostCurrent,70);
if (RapidSub.canDelegate("activity_pause")) { return pill.boxV1.pill_4.remoteMe.runUserSub(false, "pill_4","activity_pause", _userclosed);}
...
try {
		Debug.PushSubsStack("Activity_Resume (pill_4) ","pill_4",4,pill_4.mostCurrent.activityBA,pill_4.mostCurrent,66);
if (RapidSub.canDelegate("activity_resume")) { return pill.boxV1.pill_4.remoteMe.runUserSub(false, "pill_4","activity_resume");}
...
try {
		Debug.PushSubsStack("AutoCompleteEditText1_TextChanged (pill_4) ","pill_4",4,pill_4.mostCurrent.activityBA,pill_4.mostCurrent,117);
if (RapidSub.canDelegate("autocompleteedittext1_textchanged")) { return pill.boxV1.pill_4.remoteMe.runUserSub(false, "pill_4","autocompleteedittext1_textchanged", _old, _new);}
...
try {
		Debug.PushSubsStack("Button1_Click (pill_4) ","pill_4",4,pill_4.mostCurrent.activityBA,pill_4.mostCurrent,75);
if (RapidSub.canDelegate("button1_click")) { return pill.boxV1.pill_4.remoteMe.runUserSub(false, "pill_4","button1_click");}
...
if ((RemoteObject.solveBoolean(".",pill_4._etext2_flag2) || RemoteObject.solveBoolean(".",pill_4._etext3_flag3) || RemoteObject.solveBoolean(".",pill_4._etext3_flag3))) { 
 BA.debugLineNum = 96;BA.debugLine="setconnect.astreams.Write(\"p4s\".GetBytes(\"UTF8\")";
Debug.ShouldStop(-2147483648);
pill_4.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(RemoteObject.createImmutable("p4s").runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
 BA.debugLineNum = 102;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
Debug.ShouldStop(32);
pill_4.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_4.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_4.mostCurrent.activityBA,(Object)(pill_4.mostCurrent._etext2))));
 BA.debugLineNum = 103;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
Debug.ShouldStop(64);
pill_4.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_4.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_4.mostCurrent.activityBA,(Object)(pill_4.mostCurrent._etext3))));
 BA.debugLineNum = 104;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
Debug.ShouldStop(128);
pill_4.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_4.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_4.mostCurrent.activityBA,(Object)(pill_4.mostCurrent._etext4))));
 BA.debugLineNum = 105;BA.debugLine="setconnect.astreams.Write(\"p4e\".GetBytes(\"UTF8\")";
Debug.ShouldStop(256);
pill_4.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(RemoteObject.createImmutable("p4e").runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
 BA.debugLineNum = 108;BA.debugLine="Log(data_count & data_starttime & data_interval)";
Debug.ShouldStop(2048);
pill_4.mostCurrent.__c.runVoidMethod ("LogImpl","33276833",RemoteObject.concat(pill_4.mostCurrent._data_count,pill_4.mostCurrent._data_starttime,pill_4.mostCurrent._data_interval),0);
 };
...
try {
		Debug.PushSubsStack("EditText1_TextChanged (pill_4) ","pill_4",4,pill_4.mostCurrent.activityBA,pill_4.mostCurrent,135);
if (RapidSub.canDelegate("edittext1_textchanged")) { return pill.boxV1.pill_4.remoteMe.runUserSub(false, "pill_4","edittext1_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
...
try {
		Debug.PushSubsStack("EditText2_TextChanged (pill_4) ","pill_4",4,pill_4.mostCurrent.activityBA,pill_4.mostCurrent,129);
if (RapidSub.canDelegate("edittext2_textchanged")) { return pill.boxV1.pill_4.remoteMe.runUserSub(false, "pill_4","edittext2_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
...
try {
		Debug.PushSubsStack("EditText3_TextChanged (pill_4) ","pill_4",4,pill_4.mostCurrent.activityBA,pill_4.mostCurrent,123);
if (RapidSub.canDelegate("edittext3_textchanged")) { return pill.boxV1.pill_4.remoteMe.runUserSub(false, "pill_4","edittext3_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
