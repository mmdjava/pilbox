...
Debug.locals.put("input", _input);
 BA.debugLineNum = 10;BA.debugLine="Public Sub   string2byte (input As String) As Byte";
...
naseri_func.mostCurrent.__c.runVoidMethod ("LogImpl","34456461",BA.NumberToString(_i),0);
 }
}Debug.locals.put("i", _i);
;
