...
try {
		Debug.PushSubsStack("string2byte (naseri_func) ","naseri_func",5,_ba,naseri_func.mostCurrent,10);
if (RapidSub.canDelegate("string2byte")) { return pill.boxV1.naseri_func.remoteMe.runUserSub(false, "naseri_func","string2byte", _ba, _input);}
...
naseri_func.mostCurrent.__c.runVoidMethod ("LogImpl","63866637",BA.NumberToString(_i),0);
 }
}Debug.locals.put("i", _i);
;
