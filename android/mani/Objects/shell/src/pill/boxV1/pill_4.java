...
public class pill_4 implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("pill_4"), "pill.boxV1.pill_4");
	}
