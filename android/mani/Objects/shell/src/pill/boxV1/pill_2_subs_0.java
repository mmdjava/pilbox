...
if ((RemoteObject.solveBoolean(".",pill_2._etext2_flag2) || RemoteObject.solveBoolean(".",pill_2._etext3_flag3) || RemoteObject.solveBoolean(".",pill_2._etext3_flag3))) { 
 BA.debugLineNum = 95;BA.debugLine="setconnect.astreams.Write(\"p2s\".GetBytes(\"UTF8\")";
Debug.ShouldStop(1073741824);
pill_2.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(RemoteObject.createImmutable("p2s").runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
 BA.debugLineNum = 101;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
Debug.ShouldStop(16);
pill_2.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_2.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_2.mostCurrent.activityBA,(Object)(pill_2.mostCurrent._etext2))));
 BA.debugLineNum = 102;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
Debug.ShouldStop(32);
pill_2.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_2.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_2.mostCurrent.activityBA,(Object)(pill_2.mostCurrent._etext3))));
 BA.debugLineNum = 103;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
Debug.ShouldStop(64);
pill_2.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_2.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_2.mostCurrent.activityBA,(Object)(pill_2.mostCurrent._etext4))));
 BA.debugLineNum = 104;BA.debugLine="setconnect.astreams.Write(\"p2e\".GetBytes(\"UTF8\")";
Debug.ShouldStop(128);
pill_2.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(RemoteObject.createImmutable("p2e").runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
 BA.debugLineNum = 107;BA.debugLine="Log(data_count & data_starttime & data_interval)";
Debug.ShouldStop(1024);
pill_2.mostCurrent.__c.runVoidMethod ("LogImpl","31966113",RemoteObject.concat(pill_2.mostCurrent._data_count,pill_2.mostCurrent._data_starttime,pill_2.mostCurrent._data_interval),0);
 };
