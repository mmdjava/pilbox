...
public class pill_2 implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("pill_2"), "pill.boxV1.pill_2");
	}
...
public static pill.boxV1.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",pill_2.mostCurrent._activity,"AutoCompleteEditText1",pill_2.mostCurrent._autocompleteedittext1,"Button1",pill_2.mostCurrent._button1,"data_count",pill_2.mostCurrent._data_count,"data_interval",pill_2.mostCurrent._data_interval,"data_starttime",pill_2.mostCurrent._data_starttime,"EditText1",pill_2.mostCurrent._edittext1,"EditText2",pill_2.mostCurrent._edittext2,"EditText3",pill_2.mostCurrent._edittext3,"etext1",pill_2.mostCurrent._etext1,"etext1_flag1",pill_2._etext1_flag1,"etext2",pill_2.mostCurrent._etext2,"etext2_flag2",pill_2._etext2_flag2,"etext3",pill_2.mostCurrent._etext3,"etext3_flag3",pill_2._etext3_flag3,"etext4",pill_2.mostCurrent._etext4,"etext4_flag4",pill_2._etext4_flag4,"Label1",pill_2.mostCurrent._label1,"Label2",pill_2.mostCurrent._label2,"Label3",pill_2.mostCurrent._label3,"Label4",pill_2.mostCurrent._label4,"Main",Debug.moduleToString(pill.boxV1.main.class),"naseri_func",Debug.moduleToString(pill.boxV1.naseri_func.class),"pill_1",Debug.moduleToString(pill.boxV1.pill_1.class),"pill_3",Debug.moduleToString(pill.boxV1.pill_3.class),"pill_4",Debug.moduleToString(pill.boxV1.pill_4.class),"setconnect",Debug.moduleToString(pill.boxV1.setconnect.class),"Starter",Debug.moduleToString(pill.boxV1.starter.class)};
}
}