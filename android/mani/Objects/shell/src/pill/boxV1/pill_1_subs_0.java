...
pill_1.mostCurrent.__c.runVoidMethod ("LogImpl","31048581",RemoteObject.createImmutable("try"),0);
...
pill_1.mostCurrent.__c.runVoidMethod ("LogImpl","31048598",RemoteObject.createImmutable("catch"),0);
...
pill_1.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(pill_1.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("interval_1.txt")),(Object)(pill_1.mostCurrent._etext4));
 ...
 BA.debugLineNum = 117;BA.debugLine="If (ToggleButton.Checked) Then' And (etext2_flag2";
Debug.ShouldStop(1048576);
if ((pill_1.mostCurrent._togglebutton.runMethod(true,"getChecked")).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 119;BA.debugLine="setconnect.astreams.Write(\"p1s\".GetBytes(\"UTF8\")";
Debug.ShouldStop(4194304);
pill_1.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(RemoteObject.createImmutable("p1s").runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
 BA.debugLineNum = 120;BA.debugLine="If ToggleButton.Checked=True Then";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("=",pill_1.mostCurrent._togglebutton.runMethod(true,"getChecked"),pill_1.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 121;BA.debugLine="setconnect.astreams.Write(naseri_func.string2by";
Debug.ShouldStop(16777216);
pill_1.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_1.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_1.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("1")))));
 }else {
 BA.debugLineNum = 123;BA.debugLine="setconnect.astreams.Write(naseri_func.string2by";
Debug.ShouldStop(67108864);
pill_1.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_1.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_1.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("0")))));
 };
 BA.debugLineNum = 126;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
Debug.ShouldStop(536870912);
pill_1.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_1.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_1.mostCurrent.activityBA,(Object)(pill_1.mostCurrent._etext2))));
 BA.debugLineNum = 127;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
Debug.ShouldStop(1073741824);
pill_1.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_1.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_1.mostCurrent.activityBA,(Object)(pill_1.mostCurrent._etext3))));
 BA.debugLineNum = 128;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
Debug.ShouldStop(-2147483648);
pill_1.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_1.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_1.mostCurrent.activityBA,(Object)(pill_1.mostCurrent._etext4))));
 BA.debugLineNum = 129;BA.debugLine="setconnect.astreams.Write(\"p1e\".GetBytes(\"UTF8\")";
Debug.ShouldStop(1);
pill_1.mostCurrent._setconnect._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(RemoteObject.createImmutable("p1e").runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
 BA.debugLineNum = 132;BA.debugLine="Log(ToggleButton.Checked & data_count & data_sta";
Debug.ShouldStop(8);
pill_1.mostCurrent.__c.runVoidMethod ("LogImpl","31245224",RemoteObject.concat(pill_1.mostCurrent._togglebutton.runMethod(true,"getChecked"),pill_1.mostCurrent._data_count,pill_1.mostCurrent._data_starttime,pill_1.mostCurrent._data_interval),0);
 };
