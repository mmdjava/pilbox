...
try {
		Debug.PushSubsStack("Activity_Create (pill_3) ","pill_3",4,pill_3.mostCurrent.activityBA,pill_3.mostCurrent,19);
...
Debug.ShouldStop(262144);
 BA.debugLineNum = 21;BA.debugLine="Activity.LoadLayout(\"pill_3\")";
...
try {
		Debug.PushSubsStack("Activity_Pause (pill_3) ","pill_3",4,pill_3.mostCurrent.activityBA,pill_3.mostCurrent,29);
...
try {
		Debug.PushSubsStack("Activity_Resume (pill_3) ","pill_3",4,pill_3.mostCurrent.activityBA,pill_3.mostCurrent,25);
...
try {
		Debug.PushSubsStack("Button1_Click (pill_3) ","pill_3",4,pill_3.mostCurrent.activityBA,pill_3.mostCurrent,34);
