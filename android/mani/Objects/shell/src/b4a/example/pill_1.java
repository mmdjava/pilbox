...
public static b4a.example.pill_4 _pill_4 = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",pill_1.mostCurrent._activity,"Button1",pill_1.mostCurrent._button1,"Label1",pill_1.mostCurrent._label1,"Label2",pill_1.mostCurrent._label2,"Label3",pill_1.mostCurrent._label3,"Label4",pill_1.mostCurrent._label4,"Label5",pill_1.mostCurrent._label5,"Main",Debug.moduleToString(b4a.example.main.class),"pill_2",Debug.moduleToString(b4a.example.pill_2.class),"pill_3",Debug.moduleToString(b4a.example.pill_3.class),"pill_4",Debug.moduleToString(b4a.example.pill_4.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}