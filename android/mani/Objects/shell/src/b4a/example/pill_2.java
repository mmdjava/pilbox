...
public static b4a.example.pill_4 _pill_4 = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",pill_2.mostCurrent._activity,"Button1",pill_2.mostCurrent._button1,"Main",Debug.moduleToString(b4a.example.main.class),"pill_1",Debug.moduleToString(b4a.example.pill_1.class),"pill_3",Debug.moduleToString(b4a.example.pill_3.class),"pill_4",Debug.moduleToString(b4a.example.pill_4.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}