...
public class pill_3 extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "pill.boxV1", "pill.boxV1.pill_3");
...
RDebugUtils.currentLine=2424834;
 //BA.debugLineNum = 2424834;BA.debugLine="Activity.LoadLayout(\"pill_3\")";
mostCurrent._activity.LoadLayout("pill_3",mostCurrent.activityBA);
RDebugUtils.currentLine=2424836;
 //BA.debugLineNum = 2424836;BA.debugLine="Try";
try {RDebugUtils.currentLine=2424838;
 //BA.debugLineNum = 2424838;BA.debugLine="EditText1.Text = File.ReadString(File.DirInterna";
...
RDebugUtils.currentLine=2424839;
 //BA.debugLineNum = 2424839;BA.debugLine="EditText2.Text = File.ReadString(File.DirInterna";
...
RDebugUtils.currentLine=2424840;
 //BA.debugLineNum = 2424840;BA.debugLine="EditText3.Text = File.ReadString(File.DirInterna";
...
RDebugUtils.currentLine=2424841;
 //BA.debugLineNum = 2424841;BA.debugLine="AutoCompleteEditText1.Text = File.ReadString(Fil";
...
RDebugUtils.currentLine=2686976;
 //BA.debugLineNum = 2686976;BA.debugLine="Private Sub AutoCompleteEditText1_TextChanged (Old";
RDebugUtils.currentLine=2686978;
 //BA.debugLineNum = 2686978;BA.debugLine="etext4 = New";
mostCurrent._etext4 = _new;
RDebugUtils.currentLine=2686979;
 //BA.debugLineNum = 2686979;BA.debugLine="etext4_flag4=True";
...
RDebugUtils.currentLine=2621440;
 //BA.debugLineNum = 2621440;BA.debugLine="Private Sub Button1_Click";
RDebugUtils.currentLine=2621442;
 //BA.debugLineNum = 2621442;BA.debugLine="If(etext1_flag1=True ) Then";
if ((_etext1_flag1==anywheresoftware.b4a.keywords.Common.True)) { 
RDebugUtils.currentLine=2621443;
 //BA.debugLineNum = 2621443;BA.debugLine="File.WriteString(File.DirInternal, \"pill_naim3.t";
...
RDebugUtils.currentLine=2621445;
 //BA.debugLineNum = 2621445;BA.debugLine="If(etext2_flag2=True ) Then";
if ((_etext2_flag2==anywheresoftware.b4a.keywords.Common.True)) { 
RDebugUtils.currentLine=2621448;
 //BA.debugLineNum = 2621448;BA.debugLine="File.WriteString(File.DirInternal, \"pill_count_b";
...
RDebugUtils.currentLine=2621450;
 //BA.debugLineNum = 2621450;BA.debugLine="If(etext3_flag3=True ) Then";
if ((_etext3_flag3==anywheresoftware.b4a.keywords.Common.True)) { 
RDebugUtils.currentLine=2621454;
 //BA.debugLineNum = 2621454;BA.debugLine="File.WriteString(File.DirInternal, \"start_time_3";
...
RDebugUtils.currentLine=2621456;
 //BA.debugLineNum = 2621456;BA.debugLine="If(etext4_flag4=True ) Then";
if ((_etext4_flag4==anywheresoftware.b4a.keywords.Common.True)) { 
RDebugUtils.currentLine=2621458;
 //BA.debugLineNum = 2621458;BA.debugLine="File.WriteString(File.DirInternal, \"interval_3.t";
...
RDebugUtils.currentLine=2621460;
 //BA.debugLineNum = 2621460;BA.debugLine="If (etext2_flag2 Or etext3_flag3 Or etext3_flag3)";
if ((_etext2_flag2 || _etext3_flag3 || _etext3_flag3)) { 
RDebugUtils.currentLine=2621461;
 //BA.debugLineNum = 2621461;BA.debugLine="setconnect.astreams.Write(\"p3s\".GetBytes(\"UTF8\")";
mostCurrent._setconnect._astreams /*anywheresoftware.b4a.randomaccessfile.AsyncStreams*/ .Write("p3s".getBytes("UTF8"));
RDebugUtils.currentLine=2621467;
 //BA.debugLineNum = 2621467;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
...
RDebugUtils.currentLine=2621468;
 //BA.debugLineNum = 2621468;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
...
RDebugUtils.currentLine=2621469;
 //BA.debugLineNum = 2621469;BA.debugLine="setconnect.astreams.Write(naseri_func.string2byt";
...
RDebugUtils.currentLine=2621470;
 //BA.debugLineNum = 2621470;BA.debugLine="setconnect.astreams.Write(\"p3e\".GetBytes(\"UTF8\")";
mostCurrent._setconnect._astreams /*anywheresoftware.b4a.randomaccessfile.AsyncStreams*/ .Write("p3e".getBytes("UTF8"));
RDebugUtils.currentLine=2621473;
 //BA.debugLineNum = 2621473;BA.debugLine="Log(data_count & data_starttime & data_interval)";
anywheresoftware.b4a.keywords.Common.LogImpl("32621473",mostCurrent._data_count+mostCurrent._data_starttime+mostCurrent._data_interval,0);
 };
RDebugUtils.currentLine=2621476;
 //BA.debugLineNum = 2621476;BA.debugLine="StartActivity(\"Main\")";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)("Main"));
RDebugUtils.currentLine=2621477;
 //BA.debugLineNum = 2621477;BA.debugLine="Activity.Finish";
...
RDebugUtils.currentLine=2883584;
 //BA.debugLineNum = 2883584;BA.debugLine="Private Sub EditText1_TextChanged (Old As String,";
RDebugUtils.currentLine=2883586;
 //BA.debugLineNum = 2883586;BA.debugLine="etext1 = New";
mostCurrent._etext1 = _new;
RDebugUtils.currentLine=2883587;
 //BA.debugLineNum = 2883587;BA.debugLine="etext1_flag1=True";
...
RDebugUtils.currentLine=2818048;
 //BA.debugLineNum = 2818048;BA.debugLine="Private Sub EditText2_TextChanged (Old As String,";
RDebugUtils.currentLine=2818050;
 //BA.debugLineNum = 2818050;BA.debugLine="etext2 = New";
mostCurrent._etext2 = _new;
RDebugUtils.currentLine=2818051;
 //BA.debugLineNum = 2818051;BA.debugLine="etext2_flag2=True";
...
RDebugUtils.currentLine=2752512;
 //BA.debugLineNum = 2752512;BA.debugLine="Private Sub EditText3_TextChanged (Old As String,";
RDebugUtils.currentLine=2752514;
 //BA.debugLineNum = 2752514;BA.debugLine="etext3 = New";
mostCurrent._etext3 = _new;
RDebugUtils.currentLine=2752515;
 //BA.debugLineNum = 2752515;BA.debugLine="etext3_flag3=True";
