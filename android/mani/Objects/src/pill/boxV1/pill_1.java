...
anywheresoftware.b4a.keywords.Common.LogImpl("61310725","try",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("61310742","catch",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("61507368",BA.ObjectToString(mostCurrent._togglebutton.getChecked())+mostCurrent._data_count+mostCurrent._data_starttime+mostCurrent._data_interval,0);
 };
