...
anywheresoftware.b4a.keywords.Common.LogImpl("71703941","try",0);
...
mostCurrent._autocompleteedittext1.setText(BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"interval_2.txt")));
			...
			processBA.setLastException(e17); //BA.debugLineNum = 75;BA.debugLine="Log(\"catch\")";
anywheresoftware.b4a.keywords.Common.LogImpl("71703958","catch",0);
 //BA.debugLineNum = 76;BA.debugLine="ToggleButton.Checked=False";
mostCurrent._togglebutton.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 77;BA.debugLine="Dim newImage As Bitmap";
_newimage = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 78;BA.debugLine="newImage.Initialize(File.DirAssets, \"switch-off.";
_newimage.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"switch-off.png");
...
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"interval_2.txt",mostCurrent._etext4);
 ...
 //BA.debugLineNum = 113;BA.debugLine="If (ToggleButton.Checked And (etext2_flag2 Or ete";
...
mostCurrent._main._astreams /*anywheresoftware.b4a.randomaccessfile.AsyncStreams*/ .Write(mostCurrent._naseri_func._string2byte /*byte[]*/ (mostCurrent.activityBA,"0"));
 ...
 //BA.debugLineNum = 122;BA.debugLine="Main.astreams.Write(naseri_func.string2byte(etex";
mostCurrent._main._astreams /*anywheresoftware.b4a.randomaccessfile.AsyncStreams*/ .Write(mostCurrent._naseri_func._string2byte /*byte[]*/ (mostCurrent.activityBA,mostCurrent._etext2));
 //BA.debugLineNum = 123;BA.debugLine="Main.astreams.Write(naseri_func.string2byte(etex";
mostCurrent._main._astreams /*anywheresoftware.b4a.randomaccessfile.AsyncStreams*/ .Write(mostCurrent._naseri_func._string2byte /*byte[]*/ (mostCurrent.activityBA,mostCurrent._etext3));
 //BA.debugLineNum = 124;BA.debugLine="Main.astreams.Write(naseri_func.string2byte(etex";
...
anywheresoftware.b4a.keywords.Common.LogImpl("71900579",BA.ObjectToString(mostCurrent._togglebutton.getChecked())+mostCurrent._data_count+mostCurrent._data_starttime+mostCurrent._data_interval,0);
 };
