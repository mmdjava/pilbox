...
Sub Activity_Create(FirstTime As Boolean)
	...
	If File.Exists(File.DirInternal, "Imagepill2.png") Then
		...
		ImageView1.Bitmap = LoadBitmap(File.DirInternal, "Imagepill2.png")
	Else
...
Private Sub Button1_Click
	...
	If (ToggleButton.Checked) Then
		...
		Main.astreams.Write("p2s".GetBytes("UTF8"))
		If ToggleButton.Checked=True Then
		...
		Main.astreams.Write(naseri_func.string2byte(File.ReadString(File.DirInternal, "pill_count_box2.txt")))
		Main.astreams.Write(naseri_func.string2byte(File.ReadString(File.DirInternal, "start_time_2.txt")))
		Main.astreams.Write(naseri_func.string2byte(File.ReadString(File.DirInternal, "interval_2.txt")))
		Main.astreams.Write("p2e".GetBytes("UTF8"))
...
Sub fc_Result(Success As Boolean, Dir As String, FileName As String)
	If Success Then
		...
		File.Copy(Dir, FileName, File.DirInternal, "Imagepill2.png")
