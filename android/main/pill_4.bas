...
Sub Activity_Create(FirstTime As Boolean)
	...
	If File.Exists(File.DirInternal, "Imagepill4.png") Then
		...
		ImageView1.Bitmap = LoadBitmap(File.DirInternal, "Imagepill4.png")
	Else
...
Private Sub Button1_Click
	...
	If (ToggleButton.Checked) Then
		...
		Main.astreams.Write(naseri_func.string2byte(File.ReadString(File.DirInternal, "pill_count_box4.txt")))
		Main.astreams.Write(naseri_func.string2byte(File.ReadString(File.DirInternal, "start_time_4.txt")))
		Main.astreams.Write(naseri_func.string2byte(File.ReadString(File.DirInternal, "interval_4.txt")))
...
Sub fc_Result(Success As Boolean, Dir As String, FileName As String)
	If Success Then
		...
		File.Copy(Dir, FileName, File.DirInternal, "Imagepill4.png")
