...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",pill_3.mostCurrent._activity,"AutoCompleteEditText1",pill_3.mostCurrent._autocompleteedittext1,"Button1",pill_3.mostCurrent._button1,"data_count",pill_3.mostCurrent._data_count,"data_interval",pill_3.mostCurrent._data_interval,"data_starttime",pill_3.mostCurrent._data_starttime,"DateUtils",pill_3.mostCurrent._dateutils,"EditText1",pill_3.mostCurrent._edittext1,"EditText2",pill_3.mostCurrent._edittext2,"EditText3",pill_3.mostCurrent._edittext3,"etext1",pill_3.mostCurrent._etext1,"etext1_flag1",pill_3._etext1_flag1,"etext2",pill_3.mostCurrent._etext2,"etext2_flag2",pill_3._etext2_flag2,"etext3",pill_3.mostCurrent._etext3,"etext3_flag3",pill_3._etext3_flag3,"etext4",pill_3.mostCurrent._etext4,"etext4_flag4",pill_3._etext4_flag4,"Label1",pill_3.mostCurrent._label1,"Label2",pill_3.mostCurrent._label2,"Label3",pill_3.mostCurrent._label3,"Label4",pill_3.mostCurrent._label4,"Main",Debug.moduleToString(b4a.example.main.class),"naseri_func",Debug.moduleToString(b4a.example.naseri_func.class),"pill_1",Debug.moduleToString(b4a.example.pill_1.class),"pill_2",Debug.moduleToString(b4a.example.pill_2.class),"pill_4",Debug.moduleToString(b4a.example.pill_4.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"togeleButton_flge",pill_3._togelebutton_flge,"ToggleButton",pill_3.mostCurrent._togglebutton,"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}