...
try {
		Debug.PushSubsStack("string2byte (naseri_func) ","naseri_func",1,_ba,naseri_func.mostCurrent,10);
if (RapidSub.canDelegate("string2byte")) { return b4a.example.naseri_func.remoteMe.runUserSub(false, "naseri_func","string2byte", _ba, _input);}
