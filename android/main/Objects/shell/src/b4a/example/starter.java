...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"DateUtils",starter.mostCurrent._dateutils,"Main",Debug.moduleToString(b4a.example.main.class),"naseri_func",Debug.moduleToString(b4a.example.naseri_func.class),"pill_1",Debug.moduleToString(b4a.example.pill_1.class),"pill_2",Debug.moduleToString(b4a.example.pill_2.class),"pill_3",Debug.moduleToString(b4a.example.pill_3.class),"pill_4",Debug.moduleToString(b4a.example.pill_4.class),"Service",starter.mostCurrent._service,"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}