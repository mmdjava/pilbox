...
public class pill_1 implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("pill_1"), "b4a.example.pill_1");
	}
