...
try {
		Debug.PushSubsStack("Activity_Create (pill_2) ","pill_2",3,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,53);
...
Debug.ShouldStop(1048576);
 BA.debugLineNum = 55;BA.debugLine="Activity.LoadLayout(\"pill_2\")";
...
try { BA.debugLineNum = 59;BA.debugLine="ToggleButton.Checked= File.ReadString(File.DirIn";
...
pill_2.mostCurrent._autocompleteedittext1.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("interval_2.txt")))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",pill_2.processBA, e16.toString()); };
...
try {
		Debug.PushSubsStack("Activity_Pause (pill_2) ","pill_2",3,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,88);
...
try {
		Debug.PushSubsStack("Activity_Resume (pill_2) ","pill_2",3,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,84);
...
try {
		Debug.PushSubsStack("AutoCompleteEditText1_TextChanged (pill_2) ","pill_2",3,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,137);
if (RapidSub.canDelegate("autocompleteedittext1_textchanged")) { return b4a.example.pill_2.remoteMe.runUserSub(false, "pill_2","autocompleteedittext1_textchanged", _old, _new);}
...
try {
		Debug.PushSubsStack("Button1_Click (pill_2) ","pill_2",3,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,93);
...
if ((RemoteObject.solveBoolean("=",pill_2._etext1_flag1,pill_2.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 98;BA.debugLine="File.WriteString(File.DirInternal, \"pill_naim2.t";
Debug.ShouldStop(2);
...
if ((RemoteObject.solveBoolean("=",pill_2._etext3_flag3,pill_2.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 106;BA.debugLine="File.WriteString(File.DirInternal, \"start_time_2";
...
if ((RemoteObject.solveBoolean("=",pill_2._etext4_flag4,pill_2.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 110;BA.debugLine="File.WriteString(File.DirInternal, \"interval_2.t";
...
if ((pill_2.mostCurrent._togglebutton.runMethod(true,"getChecked")).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 115;BA.debugLine="Main.astreams.Write(\"p2s\".GetBytes(\"UTF8\"))";
...
pill_2.mostCurrent._main._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_2.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_2.mostCurrent.activityBA,(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("interval_2.txt")))))));
 BA.debugLineNum = 125;BA.debugLine="Main.astreams.Write(\"p2e\".GetBytes(\"UTF8\"))";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("EditText1_TextChanged (pill_2) ","pill_2",3,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,155);
if (RapidSub.canDelegate("edittext1_textchanged")) { return b4a.example.pill_2.remoteMe.runUserSub(false, "pill_2","edittext1_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
...
try {
		Debug.PushSubsStack("EditText2_TextChanged (pill_2) ","pill_2",3,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,149);
if (RapidSub.canDelegate("edittext2_textchanged")) { return b4a.example.pill_2.remoteMe.runUserSub(false, "pill_2","edittext2_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
...
try {
		Debug.PushSubsStack("EditText3_TextChanged (pill_2) ","pill_2",3,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,143);
if (RapidSub.canDelegate("edittext3_textchanged")) { return b4a.example.pill_2.remoteMe.runUserSub(false, "pill_2","edittext3_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
...
try {
		Debug.PushSubsStack("ToggleButton_CheckedChange (pill_2) ","pill_2",3,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,162);
if (RapidSub.canDelegate("togglebutton_checkedchange")) { return b4a.example.pill_2.remoteMe.runUserSub(false, "pill_2","togglebutton_checkedchange", _checked);}
RemoteObject _newimage = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
