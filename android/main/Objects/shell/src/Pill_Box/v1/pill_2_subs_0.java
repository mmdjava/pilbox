...
try {
		Debug.PushSubsStack("Activity_Create (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,56);
if (RapidSub.canDelegate("activity_create")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","activity_create", _firsttime);}
...
Debug.ShouldStop(8388608);
 BA.debugLineNum = 58;BA.debugLine="Activity.LoadLayout(\"pill_2\")";
...
pill_2.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("pill_2")),pill_2.mostCurrent.activityBA);
 BA.debugLineNum = 61;BA.debugLine="If File.Exists(File.DirInternal, \"Imagepill2.png\"";
Debug.ShouldStop(268435456);
if (pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("Imagepill2.png"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 63;BA.debugLine="ImageView1.Bitmap = LoadBitmap(File.DirInternal,";
Debug.ShouldStop(1073741824);
pill_2.mostCurrent._imageview1.runMethod(false,"setBitmap",(pill_2.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("Imagepill2.png"))).getObject()));
 }else {
 BA.debugLineNum = 65;BA.debugLine="ToastMessageShow(\"No image found.\", False)";
Debug.ShouldStop(1);
pill_2.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("No image found.")),(Object)(pill_2.mostCurrent.__c.getField(true,"False")));
 };
 BA.debugLineNum = 68;BA.debugLine="Try";
Debug.ShouldStop(8);
try { BA.debugLineNum = 70;BA.debugLine="ToggleButton.Checked= File.ReadString(File.DirIn";
Debug.ShouldStop(32);
pill_2.mostCurrent._togglebutton.runMethodAndSync(true,"setChecked",BA.ObjectToBoolean(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("toogle_en.txt")))));
...
if (RemoteObject.solveBoolean("=",pill_2.mostCurrent._togglebutton.runMethod(true,"getChecked"),pill_2.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 74;BA.debugLine="newImage.Initialize(File.DirAssets, \"switch-on.";
Debug.ShouldStop(512);
_newimage.runVoidMethod ("Initialize",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("switch-on.png")));
 }else {
 BA.debugLineNum = 77;BA.debugLine="newImage.Initialize(File.DirAssets, \"switch-off";
Debug.ShouldStop(4096);
_newimage.runVoidMethod ("Initialize",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("switch-off.png")));
 };
 BA.debugLineNum = 79;BA.debugLine="ToggleButton.SetBackgroundImage(newImage)";
Debug.ShouldStop(16384);
pill_2.mostCurrent._togglebutton.runVoidMethod ("SetBackgroundImageNew",(Object)((_newimage.getObject())));
...
pill_2.mostCurrent._autocompleteedittext1.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("interval_2.txt")))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",pill_2.processBA, e21.toString()); };
...
try {
		Debug.PushSubsStack("Activity_Pause (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,99);
if (RapidSub.canDelegate("activity_pause")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","activity_pause", _userclosed);}
...
try {
		Debug.PushSubsStack("Activity_Resume (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,95);
if (RapidSub.canDelegate("activity_resume")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","activity_resume");}
...
try {
		Debug.PushSubsStack("AutoCompleteEditText1_TextChanged (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,148);
if (RapidSub.canDelegate("autocompleteedittext1_textchanged")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","autocompleteedittext1_textchanged", _old, _new);}
...
try {
		Debug.PushSubsStack("Button1_Click (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,104);
if (RapidSub.canDelegate("button1_click")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","button1_click");}
...
Debug.ShouldStop(512);
pill_2.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("toogle_en.txt")),(Object)(BA.ObjectToString(pill_2.mostCurrent._togglebutton.runMethod(true,"getChecked"))));
...
if ((RemoteObject.solveBoolean("=",pill_2._etext1_flag1,pill_2.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 109;BA.debugLine="File.WriteString(File.DirInternal, \"pill_naim2.t";
Debug.ShouldStop(4096);
...
if ((RemoteObject.solveBoolean("=",pill_2._etext3_flag3,pill_2.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 117;BA.debugLine="File.WriteString(File.DirInternal, \"start_time_2";
...
if ((RemoteObject.solveBoolean("=",pill_2._etext4_flag4,pill_2.mostCurrent.__c.getField(true,"True")))) { 
 BA.debugLineNum = 121;BA.debugLine="File.WriteString(File.DirInternal, \"interval_2.t";
...
if ((pill_2.mostCurrent._togglebutton.runMethod(true,"getChecked")).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 126;BA.debugLine="Main.astreams.Write(\"p2s\".GetBytes(\"UTF8\"))";
...
pill_2.mostCurrent._main._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_2.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_2.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("1")))));
 }else {
 BA.debugLineNum = 130;BA.debugLine="Main.astreams.Write(naseri_func.string2byte(\"0\"";
Debug.ShouldStop(2);
pill_2.mostCurrent._main._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_2.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_2.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("0")))));
 };
 BA.debugLineNum = 133;BA.debugLine="Main.astreams.Write(naseri_func.string2byte(File";
Debug.ShouldStop(16);
pill_2.mostCurrent._main._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_2.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_2.mostCurrent.activityBA,(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("pill_count_box2.txt")))))));
 BA.debugLineNum = 134;BA.debugLine="Main.astreams.Write(naseri_func.string2byte(File";
Debug.ShouldStop(32);
pill_2.mostCurrent._main._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_2.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_2.mostCurrent.activityBA,(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("start_time_2.txt")))))));
 BA.debugLineNum = 135;BA.debugLine="Main.astreams.Write(naseri_func.string2byte(File";
Debug.ShouldStop(64);
pill_2.mostCurrent._main._astreams /*RemoteObject*/ .runVoidMethod ("Write",(Object)(pill_2.mostCurrent._naseri_func.runMethod(false,"_string2byte" /*RemoteObject*/ ,pill_2.mostCurrent.activityBA,(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("interval_2.txt")))))));
 BA.debugLineNum = 136;BA.debugLine="Main.astreams.Write(\"p2e\".GetBytes(\"UTF8\"))";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("EditText1_TextChanged (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,166);
if (RapidSub.canDelegate("edittext1_textchanged")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","edittext1_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
...
try {
		Debug.PushSubsStack("EditText2_TextChanged (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,160);
if (RapidSub.canDelegate("edittext2_textchanged")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","edittext2_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
...
try {
		Debug.PushSubsStack("EditText3_TextChanged (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,154);
if (RapidSub.canDelegate("edittext3_textchanged")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","edittext3_textchanged", _old, _new);}
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
...
try {
		Debug.PushSubsStack("fc_Result (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,195);
if (RapidSub.canDelegate("fc_result")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","fc_result", _success, _dir, _filename);}
...
Debug.ShouldStop(64);
_bmp = pill_2.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(_dir),(Object)(_filename));Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 200;BA.debugLine="ImageView1.Bitmap = bmp";
Debug.ShouldStop(128);
pill_2.mostCurrent._imageview1.runMethod(false,"setBitmap",(_bmp.getObject()));
 BA.debugLineNum = 203;BA.debugLine="File.Copy(Dir, FileName, File.DirInternal, \"Imag";
Debug.ShouldStop(1024);
pill_2.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(_dir),(Object)(_filename),(Object)(pill_2.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("Imagepill2.png")));
 BA.debugLineNum = 205;BA.debugLine="ToastMessageShow(\"Image saved successfully!\", Fa";
Debug.ShouldStop(4096);
pill_2.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Image saved successfully!")),(Object)(pill_2.mostCurrent.__c.getField(true,"False")));
 }else {
 BA.debugLineNum = 207;BA.debugLine="ToastMessageShow(\"Failed to choose an image.\", F";
Debug.ShouldStop(16384);
pill_2.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Failed to choose an image.")),(Object)(pill_2.mostCurrent.__c.getField(true,"False")));
 };
...
pill_2._togelebutton_flge = RemoteObject.createImmutable(false);
...
pill_2._togelebutton_flge = pill_2.mostCurrent.__c.getField(true,"False");
 //BA.debugLineNum = 48;BA.debugLine="Private ToggleButton As ToggleButton";
pill_2.mostCurrent._togglebutton = RemoteObject.createNew ("anywheresoftware.b4a.objects.CompoundButtonWrapper.ToggleButtonWrapper");
 //BA.debugLineNum = 50;BA.debugLine="Private ImageView1 As ImageView";
pill_2.mostCurrent._imageview1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");
 //BA.debugLineNum = 51;BA.debugLine="Dim rp As RuntimePermissions";
pill_2.mostCurrent._rp = RemoteObject.createNew ("anywheresoftware.b4a.objects.RuntimePermissions");
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _imageview1_longclick() throws Exception{
try {
		Debug.PushSubsStack("ImageView1_LongClick (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,186);
if (RapidSub.canDelegate("imageview1_longclick")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","imageview1_longclick");}
...
Debug.ShouldStop(536870912);
_fc.runVoidMethod ("Show",pill_2.processBA,(Object)(BA.ObjectToString("image/*")),(Object)(RemoteObject.createImmutable("Select Image")));
...
try {
		Debug.PushSubsStack("ToggleButton_CheckedChange (pill_2) ","pill_2",2,pill_2.mostCurrent.activityBA,pill_2.mostCurrent,173);
if (RapidSub.canDelegate("togglebutton_checkedchange")) { return Pill_Box.v1.pill_2.remoteMe.runUserSub(false, "pill_2","togglebutton_checkedchange", _checked);}
RemoteObject _newimage = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
...
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("=",_checked,pill_2.mostCurrent.__c.getField(true,"True"))) { 
