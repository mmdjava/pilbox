...
public class pill_3 implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("pill_3"), "Pill_Box.v1.pill_3");
	}
...
public static Pill_Box.v1.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",pill_3.mostCurrent._activity,"AutoCompleteEditText1",pill_3.mostCurrent._autocompleteedittext1,"Button1",pill_3.mostCurrent._button1,"data_count",pill_3.mostCurrent._data_count,"data_interval",pill_3.mostCurrent._data_interval,"data_starttime",pill_3.mostCurrent._data_starttime,"DateUtils",pill_3.mostCurrent._dateutils,"EditText1",pill_3.mostCurrent._edittext1,"EditText2",pill_3.mostCurrent._edittext2,"EditText3",pill_3.mostCurrent._edittext3,"etext1",pill_3.mostCurrent._etext1,"etext1_flag1",pill_3._etext1_flag1,"etext2",pill_3.mostCurrent._etext2,"etext2_flag2",pill_3._etext2_flag2,"etext3",pill_3.mostCurrent._etext3,"etext3_flag3",pill_3._etext3_flag3,"etext4",pill_3.mostCurrent._etext4,"etext4_flag4",pill_3._etext4_flag4,"ImageView1",pill_3.mostCurrent._imageview1,"imgView",Debug.moduleToString(Pill_Box.v1.imgview.class),"Label1",pill_3.mostCurrent._label1,"Label2",pill_3.mostCurrent._label2,"Label3",pill_3.mostCurrent._label3,"Label4",pill_3.mostCurrent._label4,"Main",Debug.moduleToString(Pill_Box.v1.main.class),"naseri_func",Debug.moduleToString(Pill_Box.v1.naseri_func.class),"pill_1",Debug.moduleToString(Pill_Box.v1.pill_1.class),"pill_2",Debug.moduleToString(Pill_Box.v1.pill_2.class),"pill_4",Debug.moduleToString(Pill_Box.v1.pill_4.class),"rp",pill_3.mostCurrent._rp,"Starter",Debug.moduleToString(Pill_Box.v1.starter.class),"togeleButton_flge",pill_3._togelebutton_flge,"ToggleButton",pill_3.mostCurrent._togglebutton,"XUIViewsUtils",Debug.moduleToString(Pill_Box.v1.xuiviewsutils.class)};
}
}