...
if (RapidSub.canDelegate("addstubtoclvifneeded")) { return Pill_Box.v1.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","addstubtoclvifneeded", _ba, _customlistview1, _color);}
...
try {
		Debug.PushSubsStack("CreateB4XImageView (xuiviewsutils) ","xuiviewsutils",33,_ba,xuiviewsutils.mostCurrent,85);
if (RapidSub.canDelegate("createb4ximageview")) { return Pill_Box.v1.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createb4ximageview", _ba);}
RemoteObject _iv = RemoteObject.declareNull("Pill_Box.v1.b4ximageview");
...
Debug.JustUpdateDeviceLine();
_iv = RemoteObject.createNew ("Pill_Box.v1.b4ximageview");Debug.locals.put("iv", _iv);
 BA.debugLineNum = 87;BA.debugLine="iv.Initialize(Null, \"\")";
Debug.JustUpdateDeviceLine();
_iv.runClassMethod (Pill_Box.v1.b4ximageview.class, "_initialize" /*RemoteObject*/ ,_ba,(Object)(xuiviewsutils.mostCurrent.__c.getField(false,"Null")),(Object)(RemoteObject.createImmutable("")));
...
try {
		Debug.PushSubsStack("CreateLabel (xuiviewsutils) ","xuiviewsutils",33,_ba,xuiviewsutils.mostCurrent,78);
if (RapidSub.canDelegate("createlabel")) { return Pill_Box.v1.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createlabel", _ba);}
...
if (RapidSub.canDelegate("initialize")) { return Pill_Box.v1.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","initialize", _ba);}
;
...
if (RapidSub.canDelegate("performhapticfeedback")) { return Pill_Box.v1.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","performhapticfeedback", _ba, _view);}
...
try {
		Debug.PushSubsStack("SetAlpha (xuiviewsutils) ","xuiviewsutils",33,_ba,xuiviewsutils.mostCurrent,95);
if (RapidSub.canDelegate("setalpha")) { return Pill_Box.v1.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setalpha", _ba, _view, _level);}
RemoteObject _jo = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
...
if (RapidSub.canDelegate("setbitmapandfill")) { return Pill_Box.v1.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setbitmapandfill", _ba, _imageview, _bmp);}
...
if (RapidSub.canDelegate("settextorcsbuildertolabel")) { return Pill_Box.v1.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","settextorcsbuildertolabel", _ba, _xlbl, _text);}
;
