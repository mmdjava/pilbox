...
public class main implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("main"), "Pill_Box.v1.main");
	}
...
public static RemoteObject _historyfile = RemoteObject.createImmutable("");
...
public static RemoteObject _initialdata1 = RemoteObject.createImmutable(0);
public static RemoteObject _initialdata2 = RemoteObject.createImmutable(0);
public static RemoteObject _initialdata3 = RemoteObject.createImmutable(0);
public static RemoteObject _initialdata4 = RemoteObject.createImmutable(0);
public static RemoteObject _rp = RemoteObject.declareNull("anywheresoftware.b4a.objects.RuntimePermissions");
public static RemoteObject _scrollinglabel1 = RemoteObject.declareNull("Pill_Box.v1.scrollinglabel");
public static RemoteObject _b4xfloattextfield1 = RemoteObject.declareNull("Pill_Box.v1.b4xfloattextfield");
...
public static RemoteObject _currenttime = RemoteObject.createImmutable(0L);
public static RemoteObject _hour = RemoteObject.createImmutable(0);
public static RemoteObject _minute = RemoteObject.createImmutable(0);
public static RemoteObject _currentdate = RemoteObject.createImmutable(0L);
public static RemoteObject _day = RemoteObject.createImmutable(0);
...
public static Pill_Box.v1.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"astreams",main._astreams,"B4XFloatTextField1",main.mostCurrent._b4xfloattextfield1,"box1_alarm",main._box1_alarm,"box2_alarm",main._box2_alarm,"box3_alarm",main._box3_alarm,"box4_alarm",main._box4_alarm,"count",main._count,"currentDate",main._currentdate,"currentTime",main._currenttime,"data1",main._data1,"data2",main._data2,"data3",main._data3,"data4",main._data4,"data5",main._data5,"data6",main._data6,"data7",main._data7,"data8",main._data8,"data9",main._data9,"date",main.mostCurrent._date,"DateUtils",main.mostCurrent._dateutils,"day",main._day,"historyFile",main.mostCurrent._historyfile,"hour",main._hour,"Imagepill1",main.mostCurrent._imagepill1,"Imagepill2",main.mostCurrent._imagepill2,"Imagepill3",main.mostCurrent._imagepill3,"Imagepill4",main.mostCurrent._imagepill4,"imgView",Debug.moduleToString(Pill_Box.v1.imgview.class),"initialData1",main._initialdata1,"initialData2",main._initialdata2,"initialData3",main._initialdata3,"initialData4",main._initialdata4,"input",main._input,"interval_1",main._interval_1,"interval_2",main._interval_2,"interval_3",main._interval_3,"interval_4",main._interval_4,"label_size1",main._label_size1,"label_size2",main._label_size2,"label_size3",main._label_size3,"label_size4",main._label_size4,"Label1",main.mostCurrent._label1,"Label10",main.mostCurrent._label10,"Label11",main.mostCurrent._label11,"Label12",main.mostCurrent._label12,"Label13",main.mostCurrent._label13,"Label14",main.mostCurrent._label14,"Label15",main.mostCurrent._label15,"Label16",main.mostCurrent._label16,"Label17",main.mostCurrent._label17,"Label18",main.mostCurrent._label18,"Label19",main.mostCurrent._label19,"Label2",main.mostCurrent._label2,"Label20",main.mostCurrent._label20,"Label21",main.mostCurrent._label21,"Label3",main.mostCurrent._label3,"Label4",main.mostCurrent._label4,"Label5",main.mostCurrent._label5,"Label6",main.mostCurrent._label6,"Label7",main.mostCurrent._label7,"Label8",main.mostCurrent._label8,"Label9",main.mostCurrent._label9,"lblDate",main.mostCurrent._lbldate,"lblTime",main.mostCurrent._lbltime,"ListView1",main.mostCurrent._listview1,"Matcher",main.mostCurrent._matcher,"minute",main._minute,"month",main._month,"naseri_func",Debug.moduleToString(Pill_Box.v1.naseri_func.class),"Panel1",main.mostCurrent._panel1,"Panel2",main.mostCurrent._panel2,"Panel3",main.mostCurrent._panel3,"Panel4",main.mostCurrent._panel4,"Panel5",main.mostCurrent._panel5,"pattern1",main.mostCurrent._pattern1,"pattern2",main.mostCurrent._pattern2,"pattern3",main.mostCurrent._pattern3,"pattern4",main.mostCurrent._pattern4,"pattern5",main.mostCurrent._pattern5,"pattern6",main.mostCurrent._pattern6,"pattern7",main.mostCurrent._pattern7,"pattern8",main.mostCurrent._pattern8,"pattern9",main.mostCurrent._pattern9,"pill_1",Debug.moduleToString(Pill_Box.v1.pill_1.class),"pill_2",Debug.moduleToString(Pill_Box.v1.pill_2.class),"pill_3",Debug.moduleToString(Pill_Box.v1.pill_3.class),"pill_4",Debug.moduleToString(Pill_Box.v1.pill_4.class),"pill_count_box1",main._pill_count_box1,"pill_count_box2",main._pill_count_box2,"pill_count_box3",main._pill_count_box3,"pill_count_box4",main._pill_count_box4,"pill_naim1",main._pill_naim1,"pill_naim2",main._pill_naim2,"pill_naim3",main._pill_naim3,"pill_naim4",main._pill_naim4,"rp",main.mostCurrent._rp,"ScrollingLabel1",main.mostCurrent._scrollinglabel1,"setconnect1",main.mostCurrent._setconnect1,"socket1",main._socket1,"start_time_1",main._start_time_1,"start_time_2",main._start_time_2,"start_time_3",main._start_time_3,"start_time_4",main._start_time_4,"Starter",Debug.moduleToString(Pill_Box.v1.starter.class),"time",main.mostCurrent._time,"Timer1",main._timer1,"viber",main._viber,"XUIViewsUtils",Debug.moduleToString(Pill_Box.v1.xuiviewsutils.class)};
}
}