...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Pill_Box.v1.b4xformatter");
            if (htSubs == null) {
...
public String  _addformatdata(Pill_Box.v1.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public Pill_Box.v1.b4xformatter._b4xformatdata  _copyformatdata(Pill_Box.v1.b4xformatter._b4xformatdata _data) throws Exception{
...
public Pill_Box.v1.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
Pill_Box.v1.b4xformatter._b4xformatdata _d = null;
...
public Pill_Box.v1.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (Pill_Box.v1.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public Pill_Box.v1.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
Pill_Box.v1.b4xformatter._b4xformatdata _d = null;
...
_d = (Pill_Box.v1.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public Pill_Box.v1.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
