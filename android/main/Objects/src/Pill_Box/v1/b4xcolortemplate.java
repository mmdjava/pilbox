...
public class b4xcolortemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Pill_Box.v1.b4xcolortemplate");
            if (htSubs == null) {
...
public Pill_Box.v1.b4xcolortemplate._colorpickerpart  _createpanelforbitmapcreator(String _eventname,boolean _withcheckers) throws Exception{
Pill_Box.v1.b4xcolortemplate._colorpickerpart _cpp = null;
...
public String  _drawcheckers(Pill_Box.v1.b4xcolortemplate._colorpickerpart _cpp) throws Exception{
int _size = 0;
int[] _clrs = null;
int _clr = 0;
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public ResumableSub_Show(Pill_Box.v1.b4xcolortemplate parent,Pill_Box.v1.b4xdialog _dialog) {
this.parent = parent;
