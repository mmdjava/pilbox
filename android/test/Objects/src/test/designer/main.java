...
RDebugUtils.currentLine=327682;
 //BA.debugLineNum = 327682;BA.debugLine="Msgbox(\"خطر\",\"هشدار\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("خطر"),BA.ObjectToCharSequence("هشدار"),mostCurrent.activityBA);
RDebugUtils.currentLine=327683;
 //BA.debugLineNum = 327683;BA.debugLine="ToastMessageShow(\"این پیام را جدی بگیرید\",true)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("این پیام را جدی بگیرید"),anywheresoftware.b4a.keywords.Common.True);
